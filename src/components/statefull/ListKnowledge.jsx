...
class ListKnowledge extends React.Component {
    render() {
        return(
            <Fragment>
                <div className='px-6 lg:px-36 mt-6 mb-4 text-xl font-bold text-slate-200'>Pelajari fundamental berikut sebelum mempelajari ReactJS: </div>
                
                <div id="list" className='px-6 lg:px-36'>
